...
namespace Nop.Plugin.Shipping.ByTotal
{
    public class ByTotalShippingComputationMethod : BasePlugin, IShippingRateComputationMethod
    {
        ...
        public GetShippingOptionResponse GetShippingOptions(GetShippingOptionRequest getShippingOptionRequest)
        {
            ...
            {
                //if (packageItem.BorrowCartItem.IsFreeShipping || !packageItem.BorrowCartItem.IsShipEnabled)
                //{
                //    continue;
                //}
                //subTotal += _priceCalculationService.GetSubTotal(packageItem.BorrowCartItem, true);
            }
