...
namespace Nop.Plugin.Payments.Payu
{
    ...
    public class PayuPaymentProcessor : BasePlugin, IPaymentMethod
    {
        ...
        public void PostProcessPayment(PostProcessPaymentRequest postProcessPaymentRequest)
        {
            ...
            var orderId = postProcessPaymentRequest.SubscriptionOrder.Id;
            ...
            remotePostHelper.Add("hash", myUtility.getchecksum(_PayuPaymentSettings.MerchantId.ToString(),
                postProcessPaymentRequest.SubscriptionOrder.Id.ToString(), postProcessPaymentRequest.SubscriptionOrder.SubscriptionOrderTotal.ToString(new CultureInfo("en-US", false).NumberFormat),
                "productinfo", postProcessPaymentRequest.SubscriptionOrder.BillingAddress.FirstName.ToString(),
                postProcessPaymentRequest.SubscriptionOrder.BillingAddress.Email.ToString(), _PayuPaymentSettings.Key));


            //Billing details
            remotePostHelper.Add("firstname", postProcessPaymentRequest.SubscriptionOrder.BillingAddress.FirstName.ToString());
            remotePostHelper.Add("billing_cust_address", postProcessPaymentRequest.SubscriptionOrder.BillingAddress.Address1);
            remotePostHelper.Add("phone", postProcessPaymentRequest.SubscriptionOrder.BillingAddress.PhoneNumber);
            remotePostHelper.Add("email", postProcessPaymentRequest.SubscriptionOrder.BillingAddress.Email.ToString());
