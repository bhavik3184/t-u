...
namespace Nop.Admin.Models.SubscriptionOrders
{
    public partial class GiftCardModel: BaseNopEntityModel
    {
        ...
        [NopResourceDisplayName("Admin.GiftCards.Fields.SubscriptionOrder")]
        public int? PurchasedWithSubscriptionOrderId { get; set; }
        ...
        public partial class GiftCardUsageHistoryModel : BaseNopEntityModel
        {
            ...
            [NopResourceDisplayName("Admin.GiftCards.History.SubscriptionOrder")]
