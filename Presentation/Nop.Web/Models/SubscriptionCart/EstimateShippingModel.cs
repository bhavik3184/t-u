...
namespace Nop.Web.Models.SubscriptionCart
{
    public partial class EstimateShippingModel : BaseNopModel
    {
        ...
        [NopResourceDisplayName("SubscriptionCart.EstimateShipping.Country")]
        public int? CountryId { get; set; }
        [NopResourceDisplayName("SubscriptionCart.EstimateShipping.StateProvince")]
        public int? StateProvinceId { get; set; }
        [NopResourceDisplayName("SubscriptionCart.EstimateShipping.ZipPostalCode")]
