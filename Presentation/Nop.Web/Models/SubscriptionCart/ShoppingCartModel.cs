...
namespace Nop.Web.Models.SubscriptionCart
{
    public partial class SubscriptionCartModel : BaseNopModel
    {
        public SubscriptionCartModel()
        {
            ...
            SubscriptionOrderReviewData = new SubscriptionOrderReviewDataModel();
        ...
        public string MinSubscriptionOrderSubtotalWarning { get; set; }
        ...
        public SubscriptionOrderReviewDataModel SubscriptionOrderReviewData { get; set; }
        ...
        public partial class SubscriptionOrderReviewDataModel : BaseNopModel
        {
            public SubscriptionOrderReviewDataModel()
            {
