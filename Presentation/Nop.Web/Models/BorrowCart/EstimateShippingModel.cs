...
namespace Nop.Web.Models.BorrowCart
{
    public partial class EstimateShippingModel : BaseNopModel
    {
        ...
        [NopResourceDisplayName("BorrowCart.EstimateShipping.Country")]
        public int? CountryId { get; set; }
        [NopResourceDisplayName("BorrowCart.EstimateShipping.StateProvince")]
        public int? StateProvinceId { get; set; }
        [NopResourceDisplayName("BorrowCart.EstimateShipping.ZipPostalCode")]
