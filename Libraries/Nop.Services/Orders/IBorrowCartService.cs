...
namespace Nop.Services.SubscriptionOrders
{
    ...
    /// </summary>
    public partial interface IBorrowCartService
    {
        /// <summary>
        ...
        void DeleteBorrowCartItem(BorrowCartItem borrowCartItem, bool resetCheckoutData = true,
        ...
        int DeleteExpiredBorrowCartItems(DateTime olderThanUtc);
        ...
        /// <returns>Warnings</returns>
        IList<string> GetStandardWarnings(Customer customer, BorrowCartType borrowCartType,
        ...
        /// <returns>Warnings</returns>
        IList<string> GetBorrowCartItemAttributeWarnings(Customer customer, 
        ...
        /// <param name="attributesXml">Attributes in XML format</param>
        /// <returns>Warnings</returns>
        IList<string> GetBorrowCartItemGiftCardWarnings(BorrowCartType borrowCartType,
            Product product, string attributesXml);
        ...
        /// <returns>Warnings</returns>
        IList<string> GetBorrowCartItemWarnings(Customer customer, BorrowCartType borrowCartType,
        ...
        /// <returns>Warnings</returns>
        IList<string> GetBorrowCartWarnings(IList<BorrowCartItem> borrowCart,
        ...
        BorrowCartItem FindBorrowCartItemInTheCart(IList<BorrowCartItem> borrowCart,
            BorrowCartType borrowCartType,
            Product product,
            string attributesXml = "",
        ...
        /// <param name="resetCheckoutData">A value indicating whether to reset checkout data</param>
        /// <returns>Warnings</returns>
        IList<string> UpdateBorrowCartItem(Customer customer,
        ...
        void MigrateBorrowCart(Customer fromCustomer, Customer toCustomer, bool includeCouponCodes);
    }
}
