...
namespace Nop.Services.Installation
{
    public partial class CodeFirstInstallationService : IInstallationService
    {
        ...
        protected virtual void InstallCountriesAndStates()
        {
            ...
            cIndia.StateProvinces.Add(new StateProvince
            {
                Name = "Maharashtra",
                Abbreviation = "MH",
                Published = true,
        ...
        protected virtual void InstallCustomersAndUsers(string defaultUserEmail, string defaultUserPassword)
        {
            ...
            var defaultAdminUserAddress = new Address
            {
                ...
                Address2 = "",
                City = "New York",
                StateProvince = _stateProvinceRepository.Table.FirstOrDefault(sp => sp.Name == "MAHARASHTRA"),
                Country = _countryRepository.Table.FirstOrDefault(c => c.ThreeLetterIsoCode == "IND"),
                ZipPostalCode = "10021",
                CreatedOnUtc = DateTime.UtcNow,
            };
            ...
            var messageTemplates = new List<MessageTemplate>
                               {
                                   ...
                                   new MessageTemplate
                                       {
                                           Name = "MyToyBox.EmailAFriend",
                                           Subject = "%Store.Name%. MyToyBox",
                                           Body = "<p><a href=\"%Store.URL%\"> %Store.Name%</a> <br /><br />%MyToyBox.Email% was shopping on %Store.Name% and wanted to share a mytoybox with you. <br /><br /><br />For more info click <a target=\"_blank\" href=\"%MyToyBox.URLForCustomer%\">here</a> <br /><br /><br />%MyToyBox.PersonalMessage%<br /><br />%Store.Name%</p>",
                                           IsActive = true,
                                           EmailAccountId = eaGeneral.Id,
                                       },
                                   new MessageTemplate
        ...
        protected virtual void InstallSettings()
        {
            ...
            settingService.SaveSetting(new CatalogSettings
                {
                    ...
                    DisplayTaxShippingInfoBorrowCart = false,
                    DisplayTaxShippingInfoMyToyBox = false,
            ...
            settingService.SaveSetting(new RewardPointsSettings
                {
                    ...
                    PointsForPurchases_Awarded = SubscriptionOrderStatus.Complete,
                    PointsForPurchases_Canceled = SubscriptionOrderStatus.Cancelled,
            ...
            settingService.SaveSetting(new CurrencySettings
                {
                    ...
                    PrimaryStoreCurrencyId = _currencyRepository.Table.Single(c => c.CurrencyCode == "INR").Id,
                    PrimaryExchangeRateCurrencyId = _currencyRepository.Table.Single(c => c.CurrencyCode == "INR").Id,
            ...
            settingService.SaveSetting(new BorrowCartSettings
                {
                    DisplayCartAfterAddingProduct = false,
                    DisplayMyToyBoxAfterAddingProduct = false,
                    MaximumBorrowCartItems = 1000,
                    MaximumMyToyBoxItems = 1000,
                    AllowOutOfStockItemsToBeAddedToMyToyBox = false,
                    MoveItemsFromMyToyBoxToCart = true,
                    ShowProductImagesOnBorrowCart = true,
                    ShowProductImagesOnWishList = true,
                    ShowDiscountBox = true,
                    ShowGiftCardBox = true,
                    CrossSellsNumber = 4,
                    EmailMyToyBoxEnabled = true,
                    AllowAnonymousUsersToEmailMyToyBox = false,
                    MiniBorrowCartEnabled = true,
                    ShowProductImagesInMiniBorrowCart = true,
                    MiniBorrowCartProductNumber = 5,
                    RoundPricesDuringCalculation = true,
                    GroupTierPricesForDistinctBorrowCartItems = false,
            ...
            settingService.SaveSetting(new OrderSettings
                {
                    ...
                    TermsOfServiceOnBorrowCartPage = true,
            ...
            settingService.SaveSetting(new ForumSettings
                {
                    ...
                    AllowCustomersToManageSubscriptionOrders = false,
            ...
            var activityLogTypes = new List<ActivityLogType>
                                      {
                                          ...
                                          new ActivityLogType
                                              {
                                                  SystemKeyword = "PublicStore.AddToBorrowCart",
                                                  Enabled = false,
                                                  Name = "Public store. Add to shopping cart"
                                              },
                                          new ActivityLogType
                                              {
                                                  SystemKeyword = "PublicStore.AddToMyToyBox",
                                                  Enabled = false,
                                                  Name = "Public store. Add to mytoybox"
                                              },
                                          new ActivityLogType
                                              {
