...
namespace Nop.Services.Catalog
{
    ...
    /// </summary>
    public partial class PlanAttributeFormatter : IPlanAttributeFormatter
    {
        ...
        public PlanAttributeFormatter(IWorkContext workContext,
        ...
        public virtual string FormatAttributes(Plan product, string attributesXml)
        {
                            ...
                            if (int.TryParse(valueStr, out attributeValueId))
                            {
                                ...
                                if (attributeValue != null)
                                {
                                    ...
                                    if (renderPrices)
                                    {
                                        ...
                                        decimal priceAdjustmentBase = _taxService.GetPlanPrice(product, attributeValuePriceAdjustment, customer, out taxRate);
