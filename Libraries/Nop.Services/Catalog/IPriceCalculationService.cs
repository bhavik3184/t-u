...
namespace Nop.Services.Catalog
{
    ...
    public partial interface IPriceCalculationService
    {
        ...
        decimal GetFinalPrice(Plan product,
            Customer customer,
        ...
        decimal GetUnitPrice(SubscriptionCartItem borrowCartItem,
            bool includeDiscounts = true);
        /// <summary>
        /// Gets the shopping cart unit price (one item)
        /// </summary>
        ...
        /// <param name="appliedDiscount">Applied discount</param>
        /// <returns>Shopping cart unit price (one item)</returns>
        decimal GetUnitPrice(Plan product,
            Customer customer,
        ...
        decimal GetSubTotal(SubscriptionCartItem borrowCartItem,
            bool includeDiscounts = true);
        /// <summary>
        /// Gets the shopping cart item sub total
        /// </summary>
        ...
        decimal GetProductCost(Plan product, string attributesXml);
        ...
        /// <param name="includeDiscounts">A value indicating whether include discounts or not for price computation</param>
        /// <returns>Shopping cart unit price (one item)</returns>
        decimal GetUnitPrice(BorrowCartItem borrowCartItem,
            bool includeDiscounts = true);
        /// <summary>
        /// Gets the shopping cart unit price (one item)
        /// </summary>
        ...
        /// <param name="includeDiscounts">A value indicating whether include discounts or not for price computation</param>
        /// <returns>Shopping cart item sub total</returns>
        decimal GetSubTotal(BorrowCartItem borrowCartItem,
            bool includeDiscounts = true);
        /// <summary>
        /// Gets the shopping cart item sub total
        /// </summary>
