...
namespace Nop.Services.SubscriptionOrders
{
    ...
    public partial class GiftCardService : IGiftCardService
    {
        ...
        public virtual IPagedList<GiftCard> GetAllGiftCards(int? purchasedWithSubscriptionOrderId = null,
            ...
            int pageIndex = 0, int pageSize = int.MaxValue)
        {
            ...
            if (purchasedWithSubscriptionOrderId.HasValue)
                query = query.Where(gc => gc.PurchasedWithSubscriptionOrderItem != null && gc.PurchasedWithSubscriptionOrderItem.SubscriptionOrderId == purchasedWithSubscriptionOrderId.Value);
        ...
        public virtual IList<GiftCard> GetGiftCardsByPurchasedWithSubscriptionOrderItemId(int purchasedWithSubscriptionOrderItemId)
        {
            if (purchasedWithSubscriptionOrderItemId == 0)
                return new List<GiftCard>();

            var query = _giftCardRepository.Table;
            query = query.Where(gc => gc.PurchasedWithSubscriptionOrderItemId.HasValue && gc.PurchasedWithSubscriptionOrderItemId.Value == purchasedWithSubscriptionOrderItemId);
