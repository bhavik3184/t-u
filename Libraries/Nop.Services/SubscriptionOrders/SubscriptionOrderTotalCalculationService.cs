...
namespace Nop.Services.SubscriptionOrders
{
    ...
    /// </summary>
    public partial class SubscriptionOrderTotalCalculationService : ISubscriptionOrderTotalCalculationService
    {
        #region Fields
        ...
        public SubscriptionOrderTotalCalculationService(IWorkContext workContext,
        ...
        /// <param name="orderSubTotal">SubscriptionOrder subtotal</param>
        /// <param name="appliedDiscount">Applied discount</param>
        /// <returns>SubscriptionOrder discount</returns>
        protected virtual decimal GetSubscriptionOrderSubtotalDiscount(Customer customer,
            decimal orderSubTotal, out Discount appliedDiscount)
        {
            ...
            var allDiscounts = _discountService.GetAllDiscounts(DiscountType.AssignedToSubscriptionOrderSubTotal);
            var allowedDiscounts = new List<Discount>();
            if (allDiscounts != null)
                foreach (var discount in allDiscounts)
                    if (_discountService.ValidateDiscount(discount, customer).IsValid &&
                               discount.DiscountType == DiscountType.AssignedToSubscriptionOrderSubTotal &&
        ...
        /// </summary>
        /// <param name="customer">Customer</param>
        /// <param name="orderTotal">SubscriptionOrder total</param>
        /// <param name="appliedDiscount">Applied discount</param>
        /// <returns>SubscriptionOrder discount</returns>
        protected virtual decimal GetSubscriptionOrderTotalDiscount(Customer customer, decimal orderTotal, out Discount appliedDiscount)
        {
            appliedDiscount = null;
            decimal discountAmount = decimal.Zero;
            if (_catalogSettings.IgnoreDiscounts)
            ...
            var allDiscounts = _discountService.GetAllDiscounts(DiscountType.AssignedToSubscriptionOrderTotal);
            var allowedDiscounts = new List<Discount>();
            if (allDiscounts != null)
                foreach (var discount in allDiscounts)
                    if (_discountService.ValidateDiscount(discount, customer).IsValid &&
        ...
        public virtual void GetSubscriptionCartSubTotal(IList<SubscriptionCartItem> cart,
            bool includingTax, 
            ...
            out decimal subTotalWithoutDiscount, out decimal subTotalWithDiscount)
        {
            ...
            GetSubscriptionCartSubTotal(cart, includingTax, 
                out  registrationAmount, out  depositAmount,
        ...
        {
            discountAmount = decimal.Zero;
            registrationAmount = decimal.Zero;
            ...
            foreach (var borrowCartItem in cart)
            {
                ...
                decimal taxRate;
                decimal sciExclTax = _taxService.GetPlanPrice(borrowCartItem.Plan, sciSubTotal, false, customer, out taxRate);
                decimal sciInclTax = _taxService.GetPlanPrice(borrowCartItem.Plan, sciSubTotal, true, customer, out taxRate);
                subTotalExclTaxWithoutDiscount += sciExclTax;
                subTotalInclTaxWithoutDiscount += sciInclTax;
                registrationAmount = borrowCartItem.RegistrationCharge - borrowCartItem.Customer.RegistrationChargeBalance;
                depositAmount = borrowCartItem.SecurityDeposit - borrowCartItem.Customer.SecurityDepositBalance;
                if (depositAmount < 0)
                    depositAmount = 0;
                //tax rates
            ...
            decimal discountAmountExclTax = GetSubscriptionOrderSubtotalDiscount(customer, subTotalExclTaxWithoutDiscount, out appliedDiscount);
        ...
        public virtual decimal GetSubscriptionCartAdditionalShippingCharge(IList<SubscriptionCartItem> cart)
        {
        ...
        public virtual bool IsFreeShipping(IList<SubscriptionCartItem> cart)
        {
            Customer customer = cart.GetCustomer();
            if (customer != null)
            {
            ...
            if (_shippingSettings.FreeShippingOverXEnabled)
            {
                ...
                decimal subTotalRegistrationAmount;
                decimal subTotalDepsitAmount;
                GetSubscriptionCartSubTotal(cart, _shippingSettings.FreeShippingOverXIncludingTax, out subTotalRegistrationAmount, out subTotalDepsitAmount, out subTotalDiscountAmount,
            ...
            IList<SubscriptionCartItem> cart, out Discount appliedDiscount)
        {
            ...
            decimal additionalShippingCharge = GetSubscriptionCartAdditionalShippingCharge(cart);
        ...
        public virtual decimal? GetSubscriptionCartShippingTotal(IList<SubscriptionCartItem> cart)
        {
            bool includingTax = _workContext.TaxDisplayType == TaxDisplayType.IncludingTax;
            return GetSubscriptionCartShippingTotal(cart, includingTax);
        }
        ...
        /// <param name="includingTax">A value indicating whether calculated price should include tax</param>
        /// <returns>Shipping total</returns>
        public virtual decimal? GetSubscriptionCartShippingTotal(IList<SubscriptionCartItem> cart, bool includingTax)
        {
            decimal taxRate;
            return GetSubscriptionCartShippingTotal(cart, includingTax, out taxRate);
        }
            ...
            out decimal taxRate)
        {
            ...
            return GetSubscriptionCartShippingTotal(cart, includingTax, out taxRate, out appliedDiscount);
        }
        ...
        public virtual decimal GetTaxTotal(IList<SubscriptionCartItem> cart, bool usePaymentMethodAdditionalFee = true)
        {
            if (cart == null)
        ...
        /// <param name="usePaymentMethodAdditionalFee">A value indicating whether we should use payment method additional fee when calculating tax</param>
        /// <returns>Tax total</returns>
        public virtual decimal GetTaxTotal(IList<SubscriptionCartItem> cart,
            out SortedDictionary<decimal, decimal> taxRates, bool usePaymentMethodAdditionalFee = true)
        {
            ...
            decimal subTotalWithoutDiscountBase;
            decimal subTotalWithDiscountBase;
            decimal orderSubTotalRegistrationAmount;
            decimal orderSubTotalDepositAmount;
            SortedDictionary<decimal, decimal> orderSubTotalTaxRates;
            GetSubscriptionCartSubTotal(cart, false,
                out orderSubTotalRegistrationAmount, out orderSubTotalDepositAmount,
            ...
            {
                decimal taxRate;
                decimal? shippingExclTax = GetSubscriptionCartShippingTotal(cart, false, out taxRate);
                decimal? shippingInclTax = GetSubscriptionCartShippingTotal(cart, true, out taxRate);
        ...
        public virtual decimal? GetSubscriptionCartTotal(IList<SubscriptionCartItem> cart,
            bool ignoreRewardPonts = false, bool usePaymentMethodAdditionalFee = true)
        {
            ...
            return GetSubscriptionCartTotal(cart, 
                out registrationAmount, 
                out depositAmount,
                out discountAmount,
                out appliedDiscount,
            ...
            bool ignoreRewardPonts = false, bool usePaymentMethodAdditionalFee = true)
        {
            ...
            registrationAmount = subTotalRegistrationBase;
            depositAmount = subTotalDepositBase;
            //shipping without tax
            decimal? borrowCartShipping = GetSubscriptionCartShippingTotal(cart, false);
            ...
            #region SubscriptionOrder total discount

            discountAmount = GetSubscriptionOrderTotalDiscount(customer, resultTemp, out appliedDiscount);
