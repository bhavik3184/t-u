...
namespace Nop.Services.SubscriptionOrders
{
    ...
    public partial class RewardPointService : IRewardPointService
    {
        ...
        /// <param name="usedWithSubscriptionOrder">The order for which points were redeemed (spent) as a payment</param>
        /// <param name="usedAmount">Used amount</param>
        public virtual void AddRewardPointsHistoryEntry(Customer customer,
            int points, int storeId, string message = "",
            SubscriptionOrder usedWithSubscriptionOrder = null, decimal usedAmount = 0M)
        {
            if (customer == null)
