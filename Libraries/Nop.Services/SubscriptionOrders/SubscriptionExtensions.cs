...
{
    public static class SubscriptionOrderExtensions
    {
        /// <summary>
        ...
        public static string FormatSubscriptionOrderNoteText(this SubscriptionOrderNote orderNote)
        {
            if (orderNote == null)
        ...
        public static int GetTotalNumberOfItemsInAllShipment(this ItemDetail itemDetail)
        {
            if (itemDetail == null)
                throw new ArgumentNullException("orderItem");

            var totalInShipments = 0;
            var shipments = itemDetail.OrderItem.Shipments.ToList();
            for (int i = 0; i < shipments.Count; i++)
            {
                var shipment = shipments[i];
                var si = shipment.ShipmentItems
                    .FirstOrDefault(x => x.ItemDetailId == itemDetail.Id);
                if (si != null)
                {
        ...
        public static int GetTotalNumberOfItemsCanBeAddedToShipment(this ItemDetail itemDetail)
        {
            if (itemDetail == null)
                throw new ArgumentNullException("orderItem");

            var totalInShipments = itemDetail.GetTotalNumberOfItemsInAllShipment();
        ...
        public static int GetTotalNumberOfNotYetShippedItems(this ItemDetail itemDetail)
        {
            if (itemDetail == null)
                throw new ArgumentNullException("orderItem");
        ...
        public static int GetTotalNumberOfShippedItems(this ItemDetail itemDetail)
        {
            if (itemDetail == null)
                throw new ArgumentNullException("orderItem");
        ...
        public static int GetTotalNumberOfDeliveredItems(this ItemDetail itemDetail)
        {
            if (itemDetail == null)
                throw new ArgumentNullException("orderItem");
        ...
        public static bool HasItemsToAddToShipment(this SubscriptionOrder order)
        {
            if (order == null)
            ...
            foreach (var orderItem in order.OrderItems)
            {
                foreach (var itemDetail in orderItem.ItemDetails)
                {
                    ...
                    var totalNumberOfItemsCanBeAddedToShipment = itemDetail.GetTotalNumberOfItemsCanBeAddedToShipment();
        ...
        public static bool HasItemsToAddToShipment(this OrderItem orderItem)
        {
            if (orderItem == null)
                throw new ArgumentNullException("orderItem");
        ...
        public static bool HasItemsToShip(this SubscriptionOrder order)
        {
            if (order == null)
                throw new ArgumentNullException("order");
            ...
            foreach (var orderItem in order.OrderItems)
            {
                foreach (var itemDetail in orderItem.ItemDetails)
                {
                    ...
                    var totalNumberOfNotYetShippedItems = itemDetail.GetTotalNumberOfNotYetShippedItems();
        ...
        public static bool HasItemsToShip(this OrderItem orderItem)
        {
            if (orderItem == null)
                throw new ArgumentNullException("orderItem");
        ...
        public static bool HasItemsToDeliver(this SubscriptionOrder order)
        {
            if (order == null)
                throw new ArgumentNullException("order");
            ...
            foreach (var orderItem in order.OrderItems)
            {
                foreach (var itemDetail in orderItem.ItemDetails)
                {
                    ...
                    var totalNumberOfShippedItems = itemDetail.GetTotalNumberOfShippedItems();
                    var totalNumberOfDeliveredItems = itemDetail.GetTotalNumberOfDeliveredItems();
