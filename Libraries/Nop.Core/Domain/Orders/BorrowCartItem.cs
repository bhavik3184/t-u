...
namespace Nop.Core.Domain.SubscriptionOrders
{
    ...
    /// </summary>
    public partial class BorrowCartItem : BaseEntity
    {
        /// <summary>
        ...
        /// </summary>
        public int BorrowCartTypeId { get; set; }
        ...
        /// Gets the log type
        /// </summary>
        public BorrowCartType BorrowCartType
        {
            get
            {
                return (BorrowCartType)this.BorrowCartTypeId;
            }
            set
            {
                this.BorrowCartTypeId = (int)value;
            }
        }
