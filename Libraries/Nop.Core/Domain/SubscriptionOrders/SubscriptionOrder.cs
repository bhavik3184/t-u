...
namespace Nop.Core.Domain.SubscriptionOrders
{
    ...
    /// Represents an order
    /// </summary>
    public partial class SubscriptionOrder : BaseEntity
    {
        ...
        private ICollection<SubscriptionOrderNote> _orderNotes;
        private ICollection<SubscriptionOrderItem> _subscriptionOrderItems;
        ...
        /// </summary>
        public decimal SubscriptionOrderShippingInclTax { get; set; }

        /// <summary>
        /// Gets or sets the order shipping (excl tax)
        /// </summary>
        public decimal SubscriptionOrderShippingExclTax { get; set; }
        ...
        /// </summary>
        public decimal SubscriptionOrderTax { get; set; }

        /// <summary>
        /// Gets or sets the order discount (applied to order total)
        /// </summary>
        public decimal SubscriptionOrderDiscount { get; set; }
        ...
        public DateTime? RefundedDepositDateUtc { get; set; }
        public decimal RefundedDepositAmount { get; set; }

        public DateTime? RefundedRegistrationDateUtc { get; set; }


        public decimal RefundedRegistrationAmount { get; set; }
        ...
        /// </summary>
        public virtual ICollection<SubscriptionOrderNote> SubscriptionOrderNotes
        {
            get { return _orderNotes ?? (_orderNotes = new List<SubscriptionOrderNote>()); }
        ...
        /// </summary>
        public virtual ICollection<SubscriptionOrderItem> SubscriptionOrderItems
        {
            get { return _subscriptionOrderItems ?? (_subscriptionOrderItems = new List<SubscriptionOrderItem>()); }
            protected set { _subscriptionOrderItems = value; }
        }
        ...
        /// </summary>
        public SubscriptionOrderStatus SubscriptionOrderStatus
        {
            get
            {
                return (SubscriptionOrderStatus)this.SubscriptionOrderStatusId;
            }
            set
            {
                this.SubscriptionOrderStatusId = (int)value;
            }
        }
