...
{
    public class SelectionBagSettings : ISettings
    {
        /// <summary>
        ...
        /// </summary>
        public int MaximumSelectionBagItems { get; set; }
        ...
        /// </summary>
        public bool ShowProductImagesOnSelectionBag { get; set; }
        ...
        /// </summary>
        public bool MiniSelectionBagEnabled { get; set; }

        /// <summary>
        /// Gets or sets a value indicating whether to show product images in the mini-shopping cart block
        /// </summary>
        public bool ShowProductImagesInMiniSelectionBag { get; set; }

        /// <summary>Gets or sets a maximum number of products which can be displayed in the mini-shopping cart block
        /// </summary>
        public int MiniSelectionBagProductNumber { get; set; }
        ...
        /// </summary>
        public bool GroupTierPricesForDistinctSelectionBagItems  { get; set; }
