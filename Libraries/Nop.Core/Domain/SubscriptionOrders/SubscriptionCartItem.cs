...
namespace Nop.Core.Domain.SubscriptionOrders
{
    ...
    /// </summary>
    public partial class SubscriptionCartItem : BaseEntity
    {
        /// <summary>
        ...
        /// </summary>
        public int SubscriptionCartTypeId { get; set; }
        ...
        public decimal PreviousRentalBalance { get; set; }
        ...
        /// Gets the log type
        /// </summary>
        public SubscriptionCartType SubscriptionCartType
        {
            get
            {
                return (SubscriptionCartType)this.SubscriptionCartTypeId;
            }
            set
            {
                this.SubscriptionCartTypeId = (int)value;
            }
        }
