...
namespace Nop.Core.Domain.SubscriptionOrders
{
    ...
    /// </summary>
    public partial class SelectionBagItem : BaseEntity
    {
        /// <summary>
        ...
        /// </summary>
        public int SelectionBagTypeId { get; set; }
        ...
        /// Gets the log type
        /// </summary>
        public SelectionBagType SelectionBagType
        {
            get
            {
                return (SelectionBagType)this.SelectionBagTypeId;
            }
            set
            {
                this.SelectionBagTypeId = (int)value;
            }
        }
