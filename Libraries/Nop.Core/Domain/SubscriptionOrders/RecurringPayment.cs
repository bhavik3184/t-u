...
namespace Nop.Core.Domain.SubscriptionOrders
{
    ...
    public partial class RecurringPayment : BaseEntity
    {
        ...
        /// </summary>
        public RecurringPlanCyclePeriod CyclePeriod
        {
            get
            {
                return (RecurringPlanCyclePeriod)this.CyclePeriodId;
            }
            set
            {
        ...
        /// </summary>
        public virtual SubscriptionOrder InitialSubscriptionOrder { get; set; }
    }
}
