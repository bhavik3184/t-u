...
{
    public class SubscriptionCartSettings : ISettings
    {
        /// <summary>
        ...
        /// </summary>
        public int MaximumSubscriptionCartItems { get; set; }
        ...
        /// </summary>
        public bool ShowProductImagesOnSubscriptionCart { get; set; }
        ...
        /// </summary>
        public bool MiniSubscriptionCartEnabled { get; set; }

        /// <summary>
        /// Gets or sets a value indicating whether to show product images in the mini-shopping cart block
        /// </summary>
        public bool ShowProductImagesInMiniSubscriptionCart { get; set; }

        /// <summary>Gets or sets a maximum number of products which can be displayed in the mini-shopping cart block
        /// </summary>
        public int MiniSubscriptionCartProductNumber { get; set; }
        ...
        /// </summary>
        public bool GroupTierPricesForDistinctSubscriptionCartItems  { get; set; }
